...
export const providerSettingsEntrySchema = z.object({
	id: z.string(),
	name: z.string(),
	isExternalModel: z.boolean().optional(),
...
const baseProviderSettingsSchema = z.object({
	...
	useExternalModel: z.boolean().optional(),
})
...
//wecode edit
const wecoderSchema = baseProviderSettingsSchema.extend({
	apiModelId: z.string().optional(),
})
//end
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	wecoderSchema.merge(z.object({ apiProvider: z.literal("wecoder") })),
	defaultSchema,
])
