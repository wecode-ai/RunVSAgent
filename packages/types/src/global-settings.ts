...
export const globalSettingsSchema = z.object({
	...
	// wecoder edit
	currentAiModelSoure: z.string().optional(),
	useExternalModel: z.boolean().optional(),
	aiModeType: z.string().optional(),
	externalRiskNoticeConfirmed: z.boolean().optional(),
	// 添加知识库选择结果字段
	knowledgeBases: z.array(z.string()).optional(),
	// 添加阻止版本更新弹窗配置
	disableVersionUpdateNotifications: z.boolean().optional(),
	// end
})
