...
export enum TelemetryEventName {
	...
	WECODER_DIFF_RECORDER_ERROR = "Diff Recorder Error",
	WECODER_DIFF_APPLICATION_SUCCESS = "DIFF APPLICATION SUCCESS",
	WECODER_DUPLICATE_CONTENT_DETECTED = "Duplicate Content Detected",
}
