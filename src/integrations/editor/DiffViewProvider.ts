...
import { recordWecodeDiffs } from "../../wecoder/core/diffs/diffRecorder"
		...
		if (diagnosticsEnabled) {
			...
			newProblemsMessage =
				newProblems.length > 0
					? `\n\nNew problems detected after saving the file:\n${newProblems} \n Always use 'read_file' tool to get newest content with line number BEFORE try fix problems`
					: ""
		}
