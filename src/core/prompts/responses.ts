...
export const formatResponse = {
	...
	toolDeniedWithFeedback: (feedback?: string) =>
		`The user denied this operation and provided the following feedback:\n<feedback>\n${feedback}\n</feedback>\nIMPORTANT: You must follow user's feedback!`,
	...
	rooIgnoreError: (path: string) =>
		`Access to ${path} is blocked by the .wecodeignore file settings. You must try to continue in the task without using this file, or ask the user to update the .wecodeignore file.`,
...
IMPORTANT: Check the previous steps and make sure you don't get stuck in a loop.
