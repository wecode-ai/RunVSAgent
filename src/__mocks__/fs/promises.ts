...
type RuleFiles = {
	".wecoderules-code": string
	".wecoderules-ask": string
	".wecoderules-architect": string
	".wecoderules-test": string
	".wecoderules-review": string
	".wecoderules": string
}
...
const mockFs = {
	readFile: vi.fn().mockImplementation(async (filePath: string, _encoding?: string) => {
		...
		const ruleFiles: RuleFiles = {
			".wecoderules-code": "# Code Mode Rules\n1. Code specific rule",
			".wecoderules-ask": "# Ask Mode Rules\n1. Ask specific rule",
			".wecoderules-architect": "# Architect Mode Rules\n1. Architect specific rule",
			".wecoderules-test":
