...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	const newPanel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "WeCoder", targetCol, {
		enableScripts: true,
	...
	newPanel.iconPath = {
		light: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "wecoder-sidebar.png"),
		dark: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "wecoder-sidebar.png"),
	}
