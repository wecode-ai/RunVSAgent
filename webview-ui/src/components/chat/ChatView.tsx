...
import WeCodeHero from "@/wecoder/welcome/WeCodeHero"
import WeCodeSwitchBar from "@/wecoder/components/chat/SwitchBar"
import Announcement from "@/wecoder/components/chat/Announcement"
		...
		(text: string, images: string[]) => {
			...
			if (text || images.length > 0) {
				...
				if (messagesRef.current.length === 0) {
					if (text.toLowerCase() === "wecoder best coder") {
