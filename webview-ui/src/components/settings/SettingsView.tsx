...
import { wecoderHandleSubmit } from "@/wecoder/components/settings/SettingsView"
...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
	...
	const handleSubmit = () => {
		if (isSettingValid) {
			...
			vscode.postMessage({ type: "fuzzyMatchThreshold", value: fuzzyMatchThreshold ?? 0.9 })
			...
			vscode.postMessage({ type: "useExternalModel", bool: useExternalModel })
			vscode.postMessage({ type: "autoRetryWithExternalModel", bool: autoRetryWithExternalModel })
			vscode.postMessage({ type: "wecoderModelConfig", text: wecoderModelConfig })

			wecoderHandleSubmit(apiConfiguration)
