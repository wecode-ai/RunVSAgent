...
import { WecoderApiOptions } from "../../wecoder/components/settings/ApiOptions"
...
const ApiOptions = ({
	...
	const docs = useMemo(() => {
		...
		// Special case for wecoder provider
		if (selectedProvider === "wecoder") {
			return {
				url: "https://wiki.api.weibo.com/zh/weibo_rd/dev/wecode/wecoder/help",
				name: name,
			}
		}
