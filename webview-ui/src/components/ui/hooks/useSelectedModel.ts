...
import { wecoderModels } from "../../../../../src/wecoder/shared/wecoder"
...
function getSelectedModel({
	...
	switch (provider) {
		...
		case "wecoder": {
			const id = apiConfiguration?.wecoderModelConfig || "wecode-auto"
			return { id: id, info: wecoderModels[id as keyof typeof wecoderModels] }
		}
		// case "anthropic":
		// case "human-relay":
		// case "fake-ai":
