...
import { WeCoderHandlerType } from "../../../src/wecoder/shared/wecoder"
import { handleWeCoderMessages } from "@/wecoder/context/handleWeCoderMessage"
...
export interface ExtensionStateContextType extends ExtensionState {
	...
	setcurrentAiModelSoure: (value: string) => void
	setExternalRiskNoticeConfirmed: (value: boolean) => void
	...
	setUseExternalModel: (value: boolean) => void
	autoRetryWithExternalModel?: boolean
	setAutoRetryWithExternalModel: (value: boolean) => void
	wecoderModelConfig?: WeCoderHandlerType
	setWecoderModelConfig: (value: WeCoderHandlerType) => void
}
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState & { organizationAllowList?: OrganizationAllowList }>({
		...
		autoRetryWithExternalModel: false,
		debugMode: false,
	...
	const contextValue: ExtensionStateContextType = {
		...
		setcurrentAiModelSoure: (value) => setState((prevState) => ({ ...prevState, currentAiModelSoure: value })),
		setExternalRiskNoticeConfirmed: (value) =>
			setState((prevState) => ({ ...prevState, externalRiskNoticeConfirmed: value })),
		setListApiConfigMeta,
		...
		setUseExternalModel: (value) => setState((prevState) => ({ ...prevState, useExternalModel: value })),
		setAutoRetryWithExternalModel: (value) =>
			setState((prevState) => ({ ...prevState, autoRetryWithExternalModel: value })),
		wecoderModelConfig: state.wecoderModelConfig,
		setWecoderModelConfig: (value) => setState((prevState) => ({ ...prevState, wecoderModelConfig: value })),
	}
